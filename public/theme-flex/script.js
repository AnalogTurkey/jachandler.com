jQuery(document).ready(function() {
    ...
    images.wrap(function () {
        ...
        if (!image.parent("a").length) {
            return "<a href='/images/" + str.substring(str.indexOf("/images/")+8,str.lastIndexOf("-")).concat(str.substring(str.lastIndexOf("."))) + "' data-featherlight='image' style=\"width:60%\"></a>";
        }
    });
    // Change styles, depending on parameters set to the image
    images.each(function (index) {
        var image = $(this);
        var o = getUrlParameter("/images/" + str.substring(str.indexOf("/images/")+8,str.lastIndexOf("-")).concat(str.substring(str.lastIndexOf("."))));
